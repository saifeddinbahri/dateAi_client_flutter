      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              numberStats(context, 30,'Total', Icons.numbers, '2.1%'),
              numberStats(context, 10,'Healthy', Icons.report_problem, '0.7%'),
            ],
          ),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              numberStats(context, 30,'Treated', Icons.query_stats, '2.1%'),
              numberStats(context, 10,'Infected', Icons.report_problem, '0.7%'),
            ],
          ),
          SizedBox(height: screenSize.height * 0.03),
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: const RepartitionMaladies(),
                ),
                Container(
                  width: screenSize.width * 0.8,
                  height: screenSize.height *0.7,
